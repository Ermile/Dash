...
class apilog
{
	...
	public static function start()
	{
		...
		self::$apilog['header']         = $headerjson = json_encode(\dash\header::get(), JSON_UNESCAPED_UNICODE | JSON_PRETTY_PRINT);
		self::$apilog['headerlen']      = mb_strlen($headerjson);
		self::$apilog['body']           = $body = json_encode(\dash\request::post(), JSON_UNESCAPED_UNICODE | JSON_PRETTY_PRINT);
	...
	public static function save($_result = null)
	{
		...
		{
			$_result = json_encode($_result, JSON_UNESCAPED_UNICODE | JSON_PRETTY_PRINT);
		}
		...
		self::$apilog['responseheader'] = json_encode(\headers_list(), JSON_UNESCAPED_UNICODE | JSON_PRETTY_PRINT);
		self::$apilog['responsebody']   = $_result;
		self::$apilog['notif']          = json_encode(\dash\notif::get(), JSON_UNESCAPED_UNICODE | JSON_PRETTY_PRINT);
