...
class view extends \addons\content_cp\main\view
{
	public function config()
	{
		...
		$this->data->page['desc']  = T_('Check list of contacts and search or filter in them to find your contacts.'). ' '. T_('Also add or edit specefic contacts.');
		// add back level to summary link
		$this->data->modulePath = $this->url('baseFull'). '/contacts';

		$this->data->page['badge']['link'] = $this->data->modulePath. '/add';
		$this->data->page['badge']['text'] = T_('Add new contacts');
