...
class twigTransTerms
{
 private function transtext()
 {
	...
	echo T_("Please select one itme");                                                // Line 138
	...
	//------------------------------------addons/content_crm/member/other/display.html
	...
	//---------------------------------------addons/content_crm/users/set/display.html
