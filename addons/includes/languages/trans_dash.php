...
class twigTransTerms
{
 private function transtext()
 {
	...
	echo T_("All");                                                                   // Line 16
	echo T_("Open tickets");                                                          // Line 17
	echo T_("Answered");                                                              // Line 18
	echo T_("Awaiting answer");                                                       // Line 19
	echo T_("Archived");                                                              // Line 20
	echo T_("New Ticket");                                                            // Line 31
	echo T_("Labels");                                                                // Line 40
	echo T_("Bug");                                                                   // Line 42
	echo T_("Feature");                                                               // Line 43
	...
	echo T_("Last active tickets");                                                   // Line 4
	echo T_("All Tickets");                                                           // Line 5
