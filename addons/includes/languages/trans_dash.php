...
class twigTransTerms
{
 private function transtext()
 {
	...
	echo T_("Select one item");                                                       // Line 128
	echo T_("Enable");                                                                // Line 238
	echo T_("Disable");                                                               // Line 239
	echo T_("Removed");                                                               // Line 132
	echo T_("Add");                                                                   // Line 53
	...
	echo T_("Two step verification");                                                 // Line 153
	echo T_("Show sidebar");                                                          // Line 120
	echo T_("Default language");                                                      // Line 55
	...
	echo T_("Enter a valid username from 3 to 40 character");                         // Line 93
	...
	echo T_("Active");                                                                // Line 129
	echo T_("Awaiting");                                                              // Line 130
	echo T_("Deactive");                                                              // Line 131
	echo T_("Filter");                                                                // Line 133
	echo T_("Unreachable");                                                           // Line 134
	echo T_("Permission");                                                            // Line 96
	echo T_("No permission");                                                         // Line 76
	...
	echo T_("Confirm password");                                                      // Line 108
	echo T_("Require to change current password");                                    // Line 108
	echo T_("Password was set, enter to change it!");                                 // Line 110
	...
	echo T_("Save remember session");                                                 // Line 144
	echo T_("Active sessions");                                                       // Line 171
	echo T_("Terminate all other sessions");                                          // Line 113
	echo T_("Browser");                                                               // Line 174
	echo T_("Operation System");                                                      // Line 175
	echo T_("IP");                                                                    // Line 24
	echo T_("Date login");                                                            // Line 177
	echo T_("Current session");                                                       // Line 179
	echo T_("Terminate");                                                             // Line 181
	...
	echo T_("chatid");                                                                // Line 40
	echo T_("Enter to change pass");                                                  // Line 99
	echo T_("Password not set, enter  to set it!");                                   // Line 110
