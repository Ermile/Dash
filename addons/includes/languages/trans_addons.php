...
class twigTransTerms
{
 private function transtext()
 {
	...
	echo T_("Clear filters");                                                         // Line 86
	echo T_("Result not found!");                                                     // Line 85
	echo T_("Search with new keywords.");                                             // Line 85
	echo T_("Hi!");                                                                   // Line 92
	...
	echo T_("Database info");                                                         // Line 21
	echo T_("Show Auto backup log file");                                             // Line 26
	echo T_("You can create backup now");                                             // Line 29
	echo T_("Backup now");                                                            // Line 30
	echo T_("Auto backup");                                                           // Line 43
	echo T_("Sise");                                                                  // Line 92
	echo T_("Download");                                                              // Line 94
	echo T_("No backup was found");                                                   // Line 99
	echo T_("Start backup every");                                                    // Line 120
	echo T_("Year");                                                                  // Line 122
	echo T_("Month");                                                                 // Line 123
	echo T_("Week");                                                                  // Line 124
	echo T_("Day");                                                                   // Line 458 Seperate
	echo T_("hour");                                                                  // Line 33 Seperate
	echo T_("Start backup at time");                                                  // Line 131
	echo T_("Life time of old backup");                                               // Line 161
	echo T_("2 years");                                                               // Line 163
	echo T_("one year");                                                              // Line 164
	echo T_("6 months");                                                              // Line 165
	echo T_("3 months");                                                              // Line 166
	echo T_("2 months");                                                              // Line 167
	echo T_("one month");                                                             // Line 168
	echo T_("one week");                                                              // Line 169
	echo T_("2 weeks");                                                               // Line 170
	echo T_("one day");                                                               // Line 171
	echo T_("3 days");                                                                // Line 172
	echo T_("5 days");                                                                // Line 173
