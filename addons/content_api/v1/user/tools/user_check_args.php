...
trait user_check_args
{
	public function user_check_args($_args, &$args, $_log_meta, $_type = 'insert')
	{
		...
		{
			if($_args['save_log']) logs::set('api:teacher:displayname:max:length', $this->user_id, $log_meta);
		...
		{
			if($_args['save_log']) logs::set('api:teacher:firstname:max:length', $this->user_id, $log_meta);
		...
		{
			if($_args['save_log']) logs::set('api:teacher:lastname:max:length', $this->user_id, $log_meta);
		...
		{
			if($_args['save_log']) logs::set('api:teacher:postion:max:length', $this->user_id, $log_meta);
		...
		{
			if($_args['save_log']) logs::set('api:teacher:code:max:length', $this->user_id, $log_meta);
		...
		{
			if($_args['save_log']) logs::set('api:teacher:status:invalid', $this->user_id, $log_meta);
		...
		{
			if($_args['save_log']) logs::set('api:teacher:nationalcode:max:length', $this->user_id, $log_meta);
		...
		{
			if($_args['save_log']) logs::set('api:teacher:father:max:length', $this->user_id, $log_meta);
		...
		{
			if($_args['save_log']) logs::set('api:teacher:birthday:max:length', $this->user_id, $log_meta);
		...
		{
			if($_args['save_log']) logs::set('api:teacher:gender:invalid', $this->user_id, $log_meta);
		...
		{
			if($_args['save_log']) logs::set('api:teacher:type:max:length', $this->user_id, $log_meta);
		...
		{
			if($_args['save_log']) logs::set('api:userteam:passportcode:max:lenght', $this->user_id, $log_meta);
		...
		{
			if($_args['save_log']) logs::set('api:userteam:passportexpire:max:lenght', $this->user_id, $log_meta);
		...
		{
			if($_args['save_log']) logs::set('api:userteam:paymentaccountnumber:max:lenght', $this->user_id, $log_meta);
		...
		{
			if($_args['save_log']) logs::set('api:userteam:cardnumber:max:lenght', $this->user_id, $log_meta);
