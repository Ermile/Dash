...
class FreeBSD extends BSDcommon
{
    ...
    public function getRam()
    {
        ...
        try {
            ...
            foreach ($sm as $swap) {
                ...
                $ft = @filetype($swap[1]); // doing... I'd rather it be Partition or File
                $return['swapInfo'][] = array(
                    'device' => $swap[1],
                    'size' => $swap[2] * 1024,
                    'used' => $swap[3] * 1024,
    ...
    public function getNet()
    {
        ...
        foreach ($netstat_match as $net) {
            ...
            $return[$net[1]] = array(
                ...
                // doing... Value for following is usually vague
    ...
    // doing... support multiple non-identical cpu's
    ...
    // doing... Get reads/writes and partitions for the drives
