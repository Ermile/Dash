<?php
namespace content_crm\users\home;
...
class view
{
	...
	public static function config()
	{
		...
		$sortLink = \content_crm\view::make_sort_link(\dash\app\user::$sort_field, \dash\url::this());
		...
		// set dataFilter
		$dataFilter = \content_crm\view::createFilterMsg($search_string, $check_empty_datatable);
